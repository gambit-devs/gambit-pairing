"""Serialization helpers for manual pairing drafts."""
...
def build_pairings_export_data(
    ...
    """Build the version-independent JSON representation of a draft."""
    return {
...
def parse_pairings_import_data(
    ...
    """Resolve a serialized pairing draft against the tournament players."""
