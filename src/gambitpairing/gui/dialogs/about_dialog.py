...
from gambitpairing.gui.gui_utils import set_native_heading
...
class AboutDialog(QtWidgets.QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self.app_name_label = required_child(self, QtWidgets.QLabel, "app_name_label")
        self.version_label = required_child(self, QtWidgets.QLabel, "version_label")
        self.description_label = required_child(
            self, QtWidgets.QLabel, "description_label"
        )
        self.support_label = required_child(self, QtWidgets.QLabel, "support_label")
        self.license_text = required_child(self, QtWidgets.QTextEdit, "license_text")
        ...
        self._load_logo()
        set_native_heading(self.app_name_label)
