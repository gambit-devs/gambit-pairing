...
class Notification(QWidget):
    """Notification widget that is a child of the provided parent.
    ...
    def update_position(self, start_pos: QtCore.QPoint, end_pos: QtCore.QPoint):
        """Call the parent stack manager to set new start/end positions.
    ...
    def leaveEvent(self, event: QtCore.QEvent):
        """Handle mouse leaving notification.
    ...
    def mousePressEvent(self, event: QtGui.QMouseEvent):
        """Handle when notification is interacted with via the mouse."""
    ...
    def _apply_styling(self):
        # Background color is still used by paintEvent
        ...
        # Is this a used variable? Kept but IDK
        self._bg_color = QtGui.QColor(bg)

        # Trigger QSS re-evaluation
